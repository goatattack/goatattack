...
const I18N::Text I18N::all_texts_english[] = {
    ...
    { I18N_MAINMENU_PUBLIC_SERVER, "public server" },
    ...
    { I18N_OPTIONS_SETTINGS45, "Rescan Controllers" },
    { I18N_OPTIONS_SETTINGS46, "Capturing" },
    { I18N_OPTIONS_SETTINGS47, "Press key or use controller..." },
    { I18N_OPTIONS_SETTINGS48, "${1} controller(s) found." },
    { I18N_OPTIONS_SETTINGS49, "Controllers" },
    ...
    { I18N_TNMT_LOBBY_SERVER, "SERVER" },
    { I18N_TNMT_LOBBY_PLAYERS, "PLAYERS" },
    { I18N_TNMT_LOBBY_START, "READY WITH FIRE" },
    { I18N_TNMT_LOBBY_SELECT_START, "SELECT TEAM, READY WITH FIRE" },
    { I18N_TNMT_LOBBY_SELECT_WAIT, "WAITING FOR PLAYERS" },
    ...
    { I18N_TNMT_TEAM_BLUE_SCORED2, "TEAM BLUE SCORES" },
    ...
    { I18N_MAINMENU_REFUSE_JOIN_IN_GAME, "refuse to join when a game is in progress" },
    { I18N_MAINMENU_PROTOCOL, "Proto" }, 
    { I18N_MAINMENU_COMPATIBLE_SERVERS, "only show compatible servers" },
